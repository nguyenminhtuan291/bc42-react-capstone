...
//chỉ có tên hàm , giống như callback function đưa định danh hàm mình sẽ hok có cắp ngoặc tròn 
//onchange khi người thay đỏi thì nó thêm change , hàm xử lý sự kiện cho input
//hàm là kết quae return của thằng trước khi user click vào nó mới chạy xún 