...
export default List;
  ...
  // Dùng hàm map để biến đổi array các object thành array các phần tử JSX chuyển về chuỗi thì mình dùng reduce , nếu chuyển mảng thì mình dung map
//tempalte coi chừng thieus key 

//render trực tip ko thông qua tạo biến 
